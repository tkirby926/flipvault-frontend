...
import { LOG_IN, PRIVACY_POLICY, TERM_OF_USE } from "@/src/utils/constants";
  ...
  return (
    <div className="min-h-screen w-full bg-signUpBg bg-no-repeat bg-center bg-cover flex items-center justify-center flex-col relative">
      <div className="container pb-8 pt-16 md:pt-20 lg:pt-24 xl:pt-24 overflow-y-scroll">
        <div className="border border-black bg-white/15 w-full max-w-[560px] min-h-[589px] mx-auto rounded-2.5 md:rounded-5 px-5 p-6 sm:py-8 md:p-8 backdrop-filter backdrop-blur-md">
